 ...
 * Use the [EditBudgetMonthly.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditBudgetMonthly : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EditBudgetMonthly.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EditBudgetMonthly().apply {
